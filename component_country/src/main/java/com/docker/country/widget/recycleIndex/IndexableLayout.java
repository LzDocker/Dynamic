...
import com.docker.country.widget.recycleIndex.database.DataObserver;
import com.docker.country.widget.recycleIndex.database.HeaderFooterDataObserver;
import com.docker.country.widget.recycleIndex.database.IndexBarDataObserver;
...
public class IndexableLayout extends FrameLayout {
    ...
    private void initCenterOverlay() {
        ...
        mCenterOverlay.setBackgroundResource(R.drawable.component_bg_center_overlay);
    ...
    private void initMDOverlay(int color) {
        ...
        mMDOverlay.setBackgroundResource(R.drawable.component_bg_center_overlay);
