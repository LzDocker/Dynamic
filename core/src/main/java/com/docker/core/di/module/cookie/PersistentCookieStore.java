...
public class PersistentCookieStore implements CookieStore {
     ...
     */
    @Inject
    public PersistentCookieStore(@ApplicationContext Context context) {
        this.cookiePrefs = context.getSharedPreferences(COOKIE_PREFS, 0);
        this.cookies = new HashMap<String, ConcurrentMap<String, Cookie>>();
    ...
    private void clearExpired() {
        ...
        for (String key : this.cookies.keySet()) {
            ...
            for (ConcurrentMap.Entry<String, Cookie> entry : cookies.get(key).entrySet()) {
